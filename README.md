...
Let us consider a sudden VIP visit or a road block due to construction in the prime areas of the city. The rider is essentially working but cannot reach any restaurants or the customers in the said zone. Our system detects the zone through data and triggers a payout for the lost time.

**Appication Workflow:**
1. Sign-up: The workers register via a mobile app andd authenticate their ID.
2. Profiling: Assigning a risk weight depending on the location.
...
1. Instead of a heavy monthly cost, the rider pays a small subscription fee, for example: Rs. 25 - Rs. 40 every Monday. The cost is recalculated every week based on upcoming data.
2. If a rider works in a flood-prone area, it is  made sure that the system is adjusts slightly to reflect the higher chance of a payout.
3. The small fees ensures that the rider never feels financial burden considering the high amount they might have to pay on a monthly basis.
...
1. Intense Rainfall: A payout is automatically triggered when rain exceeds 30mm within a 60-minute time limit, identifying conditions where road navigation becomes unsafe.
...
3. Social & Civil Disruption: We aim to utilize real-time traffic and news APIs to trigger coverage when a specific delivery zone is blocked due to unplanned strikes or political rallies.
